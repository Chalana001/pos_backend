...
@Table(
        ...
        indexes = {
                @Index(name = "idx_tenant_stock_processing_branch", columnList = "tenant_id, branch_id, processed_at"),
                @Index(name = "idx_tenant_stock_processing_source", columnList = "tenant_id, source_item_id, processed_at")
        }
)
@Getter
@Setter
