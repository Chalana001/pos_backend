...
@Table(
        ...
        uniqueConstraints = {
                @UniqueConstraint(columnNames = {"tenant_id", "claim_no"})
        },
        indexes = {
                @Index(name = "idx_tenant_warranty_claim_warranty", columnList = "tenant_id, warranty_id"),
                @Index(name = "idx_tenant_warranty_claim_branch", columnList = "tenant_id, branch_id")
        }
)
@Getter
@Setter
