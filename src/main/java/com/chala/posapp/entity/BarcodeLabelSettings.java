...
public class BarcodeLabelSettings extends TenantEntity {
    ...
    // Scale-barcode decoding used to live here (tenant V30). It moved to
    // AppConfiguration in V51: the scale prints its own labels, so its digit
    // layout belongs with the other weight-item settings, not the designer.
